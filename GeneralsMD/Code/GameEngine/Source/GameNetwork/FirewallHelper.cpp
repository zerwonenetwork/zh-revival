...
//		}
		...
		*/
		if (!found) {
			...
			UnsignedInt manglerAddress = *((UnsignedInt *)&mangler_addresses[m][0]);
			manglerAddress = ntohl(manglerAddress);
			memcpy(&mangler_addresses[m][0], &manglerAddress, sizeof(manglerAddress));

// dinput.h — DirectInput compatibility stub for non-Windows builds
//
// Provides DIK_* keyboard scan-code constants so that KeyDefs.h and other
// headers that #include <dinput.h> compile on Linux / macOS.
//
// The numeric values are the standard DirectInput / PC keyboard scan codes.
// They are hardware constants that do not change between platforms.
//
...
#pragma once
#ifndef ZH_COMPAT_DINPUT_H
#define ZH_COMPAT_DINPUT_H

#ifndef _WIN32

// ── type aliases dinput.h normally pulls from <windows.h> ──────────────────
#ifndef ZH_COMPAT_WINDOWS_H
#  include "windows.h"
#endif

// ── DirectInput keyboard scan codes (DIK_*) ────────────────────────────────
// Values are standard PC AT keyboard make-codes as used by DirectInput 8.
...
#define DIK_NUMPAD_ENTER    DIK_NUMPADENTER
